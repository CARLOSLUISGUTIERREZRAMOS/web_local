                                                    ...
                                                    <table class="table resumen">
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td><?= $data_reserva->nombres . ' ' . $data_reserva->apellidos ?></td>
                                                            </tr>
                                                            <tr>
                                                                <th>Descripción del código de acción:</th>
                                                                <td><?= $dataVisa->dataMap->ECI_DESCRIPTION ?></td>
                                                            </tr>
                                                        </tbody>
                                                    </table>
                                                </div>
