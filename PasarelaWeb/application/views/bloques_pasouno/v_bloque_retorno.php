        ...
        <div class="card-body">
            ...
            <div class="parentdiv">
                <div class="row no-gutters fechas" id="to">
                    <div class="col"><a href="#" class="dias dias_calculo <?= ValidarMuestraSabTarifaria(RestarSumarFecha($date_to, '-3'), $date_from) ?>" id="<?= RestarSumarFecha($date_to, '-3') ?>"><?=$tarifaMenorDiasAntesTresR?>$  <small><?= FechaOperaLetras_ES($date_to, '-3') ?></small></a></div>
                    <div class="col"><a href="#" class="dias dias_calculo <?= ValidarMuestraSabTarifaria(RestarSumarFecha($date_to, '-2'), $date_from) ?>" id="<?= RestarSumarFecha($date_to, '-2') ?>"><?=$tarifaMenorDiasAntesDosR?>$ <small><?= FechaOperaLetras_ES($date_to, '-2') ?></small></a></div>
                    <div class="col"><a href="#" class="dias dias_calculo <?= ValidarMuestraSabTarifaria(RestarSumarFecha($date_to, '-1'), $date_from) ?>" id="<?= RestarSumarFecha($date_to, '-1') ?>"><?=$tarifaMenorDiasAntesUnoR?>$ <small><?= FechaOperaLetras_ES($date_to, '-1') ?></small></a></div>
                    <div class="col"><a href="#" class="dias dias_calculo active"><?= $tarifa_menor ?>$ <small><?= FechaLetras_ES($date_to, 'short') ?></small></a></div>
                    <div class="col"><a href="#" class="dias dias_calculo <?= ValidarMuestraSabTarifaria(RestarSumarFecha($date_to, '+1'), $date_from) ?>" id="<?= RestarSumarFecha($date_to, '+1') ?>"><?=$tarifaMenorDiasDespuesUnoR?>$  <small><?= FechaOperaLetras_ES($date_to, '+1') ?></small></a></div>
                    <div class="col"><a href="#" class="dias dias_calculo <?= ValidarMuestraSabTarifaria(RestarSumarFecha($date_to, '+2'), $date_from) ?>" id="<?= RestarSumarFecha($date_to, '+2') ?>"><?=$tarifaMenorDiasDespuesDosR?>$  <small><?= FechaOperaLetras_ES($date_to, '+2') ?></small></a></div>
                    <div class="col"><a href="#" class="dias dias_calculo <?= ValidarMuestraSabTarifaria(RestarSumarFecha($date_to, '+3'), $date_from) ?>" id="<?= RestarSumarFecha($date_to, '+3') ?>"><?=$tarifaMenorDiasDespuesTresR?>$  <small><?= FechaOperaLetras_ES($date_to, '+3') ?></small></a></div>
                </div>
            </div>
