                                                    ...
                                                    <table class="table resumen">
                                                        <tbody>
                                                            <tr>
                                                                ...
                                                                <td><?= $this->session->pnr ?></td>
                                                            </tr>
                                                            <tr>
                                                                <th>Número de pedido:</th>
                                                                <td><?= $this->session->numero_orden ?></td>
                                                            </tr>
                                                            <tr>
                                                                <th>Moneda:</th>
                                                                <td>USD</td>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td><?= $this->session->total_pagar ?></td>
                                                            </tr>
                                                            <tr>
                                                                <th>Numero de Tarjeta:</th>
                                                                <td><?= $dataVisa->data->CARD ?></td>
                                                            </tr>
                                                            <tr>
                                                                <th>Fecha y Hora del pedido:</th>
                                                                <td><?= $this->session->fecha_hora_reserva ?></td>
                                                            </tr>
                                                            <tr>
                                                                <th>Nombre del TarjetaHabiente:</th>
                                                                <td><?= $this->session->nombre_tarjetahabiente ?></td>
                                                            </tr>
                                                            <tr>
                                                                <th>Código de error</th>
                                                                <td><?= $dataVisa->data->ECI_DESCRIPTION ?></td>
                                                            </tr>
                                                        </tbody>
                                                    </table>
                                                </div>
                                            ...
                                            <div class="row">
                                                <div class="col-11">
                                                    ...
                                                    <div class="alert alert-info" role="alert">
                                                        Por favor tome nota de su código de reserva: <?=$this->session->pnr?> e intente su pago nuevamente ingresando <a href="#!">aquí</a>
                                                    </div>
                                                    <div class="alert alert-info" role="alert">
                                    ...
                                    <tr>
                                        <th>
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" aria-describedby="codres" id="codres" value="<?= $this->session->pnr ?>" disabled>
                                            </div>
                                        </th>
                                    </tr>
                                    <tr>
                                        <th>
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" aria-describedby="montotrans" id="montotrans" value="<?= $this->session->total_pagar ?>" disabled>
                                            </div>
                                        </th>
                                    </tr>
                                </table>
